...
public class CustomerQueryNonCP implements AppConstants {

	private static final Logger logger = LogManager.getLogger(CustomerQueryNonCP.class);
	...
	public static void main(String[] args) {
		try {
			new CustomerQueryNonCP().execute();
		} catch (SQLException e) {
			e.printStackTrace();
		}
	}
